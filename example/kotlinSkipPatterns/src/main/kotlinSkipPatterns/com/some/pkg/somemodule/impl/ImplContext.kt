package src.main.kotlinSkipPatterns.com.some.pkg.somemodule.impl

import com.github.bratek20.architecture.context.api.ContextBuilder
import com.github.bratek20.architecture.context.api.ContextModule

import src.main.kotlinSkipPatterns.com.some.pkg.somemodule.api.*
import src.main.kotlinSkipPatterns.com.some.pkg.somemodule.impl.*
...
class SomeModuleImpl: ContextModule {
    override fun apply(builder: ContextBuilder) {
        builder
            ...
            .setImpl(SomeInterfaceToTestMockArgsImport::class.java, SomeInterfaceToTestMockArgsImportLogic::class.java)
