...
import { OtherDimension } from "../../OtherModule/Impl/Logic"
import { OtherDimension as OtherModuleOtherDimension } from "../../OtherModule/Impl/Track"
import { DateRange } from "../../TypesModule/Api/CustomTypes"
import { SerializedDateRange } from "../../TypesModule/Api/SerializedCustomTypes"
import { ClassWithOptExamples, SomeClass, SomeClass3 } from "../Api/ValueObjects"
...
export class SomeTrackingEvent extends TrackingEvent {
    constructor(
        ...
        dimensions_list: TrackingDimensionList,
        other_dimension_id: OtherModuleOtherDimension
    ) {
        super()
    ...
    private readonly dimensions_list: TrackingDimensionList
    private readonly other_dimension_id: OtherModuleOtherDimension
    getTableName(): TrackingTableName {
