namespace SomeModule {
    ...
    export interface SetupArgs {
        ...
        someEnumValuesReferencingPropertyList?: SomeModule.Builder.SomeEnumValuesReferencingPropertyDef[]
    ...
    export function setup(args: SetupArgs = {}): void {
        c = Ts.E2E.SetupAndCreateContext({
            ...
            titleData: builderTD => {
                ...
                builderTD.with(SOME_ENUM_VALUES_REFERENCING_PROPERTY_LIST_PROPERTY_KEY, (args.someEnumValuesReferencingPropertyList ?? []).map(it => SomeModule.Builder.someEnumValuesReferencingProperty(it)))
