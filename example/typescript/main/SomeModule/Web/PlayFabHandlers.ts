...
namespace SomeModule.Web {
    Handlers.Api.Register({
        ...
        handlers: [
            {
                name: "SomeModule.someHandler",
                handler: someHandler
            },
            {
                name: "SomeModule.someHandler2",
                handler: someHandler2
            }
        ],
        featureFlag: FeatureName.SomeModule
    })
    ...
    export function RegisterDebugHandlers() {
        Handlers.Api.Register({
            ...
            handlers: [
                {
                    name: "SomeModule.Debug.someDebugHandler",
                    handler: someDebugHandler
                },
                {
                    name: "SomeModule.Debug.someDebugHandler2",
                    handler: someDebugHandler2
                }
            ]
        })
    }
