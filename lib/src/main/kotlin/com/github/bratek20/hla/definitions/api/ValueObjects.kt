...
data class ViewModelSubmoduleDefinition(
    ...
    private val elementGroups: List<String>,
    private val optionalElements: List<String>,
    ...
    fun getElementGroups(): List<String> {
        return this.elementGroups
    }

    fun getOptionalElements(): List<String> {
